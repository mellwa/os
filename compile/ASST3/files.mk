...
SRCS+=$(KTOP)/syscall/close_syscalls.c
SRCS+=$(KTOP)/syscall/execv_syscalls.c
SRCS+=$(KTOP)/syscall/_exit_syscalls.c
SRCS+=$(KTOP)/syscall/filetable.c
SRCS+=$(KTOP)/syscall/fork_syscalls.c
SRCS+=$(KTOP)/syscall/getpid_syscalls.c
SRCS+=$(KTOP)/syscall/loadelf.c
SRCS+=$(KTOP)/syscall/open_syscalls.c
SRCS+=$(KTOP)/syscall/proctable.c
SRCS+=$(KTOP)/syscall/read_syscalls.c
SRCS+=$(KTOP)/syscall/runprogram.c
SRCS+=$(KTOP)/syscall/time_syscalls.c
SRCS+=$(KTOP)/syscall/waitpid_syscalls.c
